...
class metrics_ogb:
    ...
    def eval_ap(y_true, y_pred):
        """Stub: Average Precision for OGB datasets."""
        raise NotImplementedError("OGB metrics not available in this clean version (OGB datasets not supported).")
    
    @staticmethod
    def eval_acc(y_true, y_pred):
        """Stub: Accuracy for OGB datasets."""
        raise NotImplementedError("OGB metrics not available in this clean version (OGB datasets not supported).")
    
    @staticmethod
    def eval_rocauc(y_true, y_pred):
        """Stub: ROC-AUC for OGB datasets."""
        raise NotImplementedError("OGB metrics not available in this clean version (OGB datasets not supported).")
